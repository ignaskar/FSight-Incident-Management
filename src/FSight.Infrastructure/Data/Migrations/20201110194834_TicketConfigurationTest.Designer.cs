...
namespace FSight.Infrastructure.Data.Migrations
{
    ...
    [Migration("20201110194834_TicketConfigurationTest")]
    partial class TicketConfigurationTest
    {
            ...
            modelBuilder.Entity("FSight.Core.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 10, 19, 48, 33, 869, DateTimeKind.Utc).AddTicks(3580));
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 10, 19, 48, 33, 876, DateTimeKind.Utc).AddTicks(580));
            ...
            modelBuilder.Entity("FSight.Core.Entities.Developer", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 10, 19, 48, 33, 877, DateTimeKind.Utc).AddTicks(2090));
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 10, 19, 48, 33, 877, DateTimeKind.Utc).AddTicks(2990));
            ...
            modelBuilder.Entity("FSight.Core.Entities.ProjectManager", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 10, 19, 48, 33, 877, DateTimeKind.Utc).AddTicks(7910));
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 11, 10, 19, 48, 33, 877, DateTimeKind.Utc).AddTicks(8170));
